    ...
    return (
        <>
            ...
            <WeatherInfoContainer>
                ...
                <WeatherInfoComponent name={"Чийг"} value={weather?.main?.humidity}/>
                <WeatherInfoComponent name={"Салхи"} value={weather?.wind?.speed}/>
                <WeatherInfoComponent name={"Даралт"} value={weather?.main?.pressure}/>
            </WeatherInfoContainer>
        </>
    );
};
